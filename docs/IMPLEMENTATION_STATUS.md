...
| Football/world | Three 52-week seasons with explicit rollover, top-two/bottom-two movement between tiers, and the domestic cup. No aging/retirement, availability, fatigue, injuries, cohesion/morale effects, ongoing rival recruiting or rescue. Team ability plus home advantage is the initial match model. |
| Leadership | Three named fixed leaders; full utility policies, hiring, succession, competence and mandate negotiation remain. |
| Recruitment | Opening forward search and a separate midseason review with first-choice, lower-cost and keep-squad options. One midseason mandate per season; named contract terms persist in History. All-club autonomous recruiting, rival bidding, negotiated renewals, protected-player sales and post-failure revisions remain open. See RECRUITMENT_MARKET.md. |

...
4. Inspect **Football** for the cup, table and match moments. In season weeks 24–27, compare the director’s two forward recommendations or choose to keep the squad. Preview exact terms before authorizing a negotiation. **Business** holds forecasts and reconciliation, **People** the roster, and **History** original mandate terms and outcomes.
5. Save or use **Load / recover**. At weeks 52 and 104, review the season report and confirm next-season renewals, then choose a fresh capital plan. Week 156 completes this milestone; ownership exits remain deferred.
...
Loading any snapshot forks on the next successful write. Duplicate command receipts persist. Unsupported versions are rejected without modifying their source. Current source and the packaged executable use schema 5 and migrate schema 1–4 in memory without overwriting the original file. Steam Cloud is not implemented.
